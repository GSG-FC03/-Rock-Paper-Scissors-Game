...
//Make The Video Picture In Picture
let myVideo = document.getElementById('myVideo')
let btnPip = document.getElementById('btnPip')
if ("pictureInPictureEnabled" in document) {
    ...
    btnPip.addEventListener('click', () => {
        ...
        myVideo.addEventListener('enterpictureinpicture', e => {
            myVideo.play()
            btnPip.textContent = 'Close the video'
        })

        myVideo.addEventListener('leavepictureinpicture', e => {
            myVideo.pause()
            btnPip.textContent = 'Learn the Game'
        })
    })
}